...
add_body(
    ...
    'مع ذكر قاعدة البيانات المستخدمة، والمنهجية، والمقاييس الكمية المحققة. '
    'تُشير القيم الواردة للنموذج المقترح إلى النتائج الفعلية التي حققها النظام والمُوثَّقة في الفصل الرابع، '
    'مما يتيح المقارنة المباشرة مع الدراسات السابقة في مرحلة المراجعة الأدبية.'
)
...
make_table(
    ...
    rows=[
        [
            ...
            '2011',
            'ND-TWINS\n(Notre Dame)',
            'Probabilistic LDA + Low-Rank\nPCA على الصورة الكاملة',
            '0.165',
            '0.810',
            'لا يستخدم سمات المنطقة المحيطة بالعين؛\nأداء منخفض على التوائم المتماثلة'
        ],
        [
            'Sun et al.\n(Siamese CNN)',
            '2014',
            'ND-TWINS\n(Notre Dame)',
            'شبكة Siamese CNN لتعلّم تشابه\nأزواج الوجوه',
            '0.067',
            '0.980',
            'تتطلب بيانات تدريب ضخمة؛\nلا تعالج مشكلة تسرّب البيانات بين مجموعات التوائم'
        ],
        [
            'Sun et al.\n(DCNN Multi-Angle)',
            '2017',
            'Multi-PIE + ND-TWINS',
            'DCNN متعدد الزوايا مع\nدمج مستويات الميزات',
            '-',
            '0.842',
            'مُعقَّد حسابياً؛ يستلزم صور متعددة\nالزوايا غير متاحة دائماً'
        ],
        [
            'Toygar et al.\n(LBP+LPQ+BSIF)',
            '2019',
            'ND-TWINS 2009-2010\n(Notre Dame)',
            'مزج ملمس LBP+LPQ+BSIF\nمع مصنِّف KNN',
            '0.054',
            '0.980',
            'لا يستخدم تعلماً عميقاً؛ يعتمد على سمات\nالملمس فقط دون تمثيلات عميقة'
        ],
        [
            'Deb & Jain\n(ArcFace Standard)',
            '2021',
            'ND-TWINS\n(Notre Dame)',
            'ArcFace buffalo_l مباشر\nبدون معالجة خاصة للتوائم',
            '0.148',
            '0.921',
            'لا يطبّق Hard Negative Mining؛\nلا يدمج سمات الملمس المحلية'
        ],
        [
            'النموذج المقترح\n(هذه الدراسة)',
            '2024',
            'ND-TWINS 2009-2010\n(Notre Dame)',
            'ArcFace + LBP كامل الوجه\n+ LBP حول العين + Hard Negative Mining\n+ GroupKFold (بمجموعات التوائم)\n+ LightGBM + Optuna',
            '0.1221\n±0.008',
            '0.9559',
            'أول دراسة تطبق GroupKFold بمجموعة\nالتوائم twin_group لمنع تسرّب البيانات;\nنتائج قابلة للتكرار والتحقق'
        ],
    ],
...
add_note(
    ...
    'في الجداول 5.4 و6.4 و7.4 من الفصل الرابع. تُتيح هذه القيم المقارنة المباشرة في مرحلة الدراسات السابقة.'
)
