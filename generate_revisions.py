...
add_body(
    ...
    'مع ذكر قاعدة البيانات المستخدمة وحجم العينة وطبيعتها (أفراد أم أزواج)، '
...
make_table(
    ...
    rows=[
        [
            ...
            '0.165',
            '0.810',
            'لا يستخدم سمات منطقة\nالعين؛ أداء منخفض\nعلى التوائم المتماثلة'
        ],
        [
            'Sun et al.\n(Siamese CNN)',
            '2014',
            ...
            '0.067',
            '0.980',
            'تتطلب بيانات تدريب ضخمة؛\nلا تعالج تسرّب البيانات\nبين مجموعات التوائم'
        ],
        [
            'Sun et al.\n(DCNN Multi-Angle)',
            '2017',
            'Multi-PIE\n+ ND-TWINS',
            'Multi-PIE: 337 شخصاً\n+ ND-TWINS: ~200 شخص\n750,000+ صورة (Multi-PIE)',
            'أفراد (Multi-PIE)\n+ أزواج توائم\n(ND-TWINS)',
            'DCNN متعدد الزوايا\nمع دمج مستويات\nالميزات',
            '—',
            '0.842',
            'مُعقَّد حسابياً؛ يستلزم\nصور متعددة الزوايا\nغير متاحة دائماً'
        ],
        [
            'Toygar et al.\n(LBP+LPQ+BSIF)',
            '2019',
            ...
            '0.054',
            '0.980',
            'لا يستخدم تعلماً عميقاً؛\nيعتمد على سمات الملمس\nفقط دون تمثيلات عميقة'
        ],
        [
            'Deb & Jain\n(ArcFace Standard)',
            '2021',
...
add_note(
    '★ ملاحظة: جميع الدراسات تعمل على مستوى الأزواج (Pairs) لأن طبيعة المشكلة تقييمية (هل هذان الشخصان توأمان؟). '
    'الفارق الجوهري بين الدراسات هو طريقة تقسيم البيانات: الدراسات السابقة تُقسِّم على مستوى الأفراد '
    '(يمكن أن يظهر نفس الشخص في التدريب والاختبار)، بينما تُقسِّم هذه الدراسة على مستوى أزواج التوائم '
    '(twin_group) لمنع أي تسرّب للبيانات.'
)
add_note(
